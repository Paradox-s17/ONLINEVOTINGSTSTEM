...
?>
    <div class="alert alert-danger m-3 " role="alert">
        Candidate image is too large, please upload under 2MB.
    </div>
<?php
                ...
                <select class="form-control" name="election_id" required>
                    ...
                    if($isAnyElectionAdded > 0) {
                        while($row = mysqli_fetch_assoc($fetchingElections)) {
                            ...
                            if($added_candidate < $allowed_candidates )
                            {    
                    ?>
            ...
            <tbody>
                ...
                if($isAnyCandidateAdded > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($fetchingData)) 
                    {
                        ...
                        $fetchingElectionName = mysqli_query($db, "SELECT * FROM elections WHERE id = '".$election_id."' ") or die(myaqli_error($db));
...
if(isset($_POST['addCandidateBtn'])) {
    ...
    $candidate_photo = $targetted_folder . rand(111111111, 9999999999) . "_" . rand(111111111, 9999999999) . "_" . $_FILES['candidate_photo']['name'];
