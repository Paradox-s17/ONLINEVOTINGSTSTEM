...
<?php
    ...
    if(isset($_POST['addElectionBtn']))
    {
        ...
        mysqli_query($db, "INSERT INTO elections(election_topic, no_of_candidate, starting_date, ending_date, status, inserted_by, inserted_on) VALUES('".$election_topic."', '".$number_of_candidate."', '".$starting_date."', '".$ending_date."', '".$status."', '".$inserted_by."', '".$inserted_on."') ") or die(mysqli_error($db));
